export default function BrandLocationsMap() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto pt-10 sm:pt-14 pb-8 border-t border-black/10 text-[#1A1A1A]">
      ...
      {/* Highly Responsive Professional Single Location Layout */}
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 items-stretch bg-white border border-black/10 rounded-2xl overflow-hidden shadow-sm">
        {/* Left Side: Boutique Info Card (5 Cols on md/lg) */}
        <div className="md:col-span-5 p-6 sm:p-8 md:p-10 flex flex-col justify-between bg-white text-[#1A1A1A]">
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="px-3 py-1 bg-black/5 text-[#1A1A1A] border border-black/10 text-[9px] font-sans tracking-widest uppercase rounded-full font-medium">
                FLAGSHIP SANCTUARY
              </span>
            </div>
            ...
            <p className="font-sans text-xs sm:text-sm text-[#444444] font-light leading-relaxed mb-6">
              {primaryLocation.description}
            </p>

            {/* Address & Contact Info Box */}
            <div className="space-y-3 p-4 bg-[#F8F8F8] border border-black/5 rounded-xl text-xs font-sans">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <strong className="text-[#1A1A1A] block font-semibold uppercase text-[10px] tracking-wider">ADDRESS</strong>
                  <span className="text-[#555555]">{primaryLocation.address}</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2.5 pt-2 border-t border-black/5">
                ...
                <div>
                  <strong className="text-[#1A1A1A] block font-semibold uppercase text-[10px] tracking-wider">BOUTIQUE HOURS</strong>
              ...
              <div className="flex items-start gap-2.5 pt-2 border-t border-black/5">
                ...
                <div>
                  <strong className="text-[#1A1A1A] block font-semibold uppercase text-[10px] tracking-wider">CONCIERGE TELEPHONE</strong>
          ...
          {/* Action CTAs: Get Directions & Coordinates */}
          <div className="pt-6 mt-6 border-t border-black/10 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
            ...
            <a
              ...
              className="px-6 py-3 text-xs font-sans font-bold tracking-[0.25em] uppercase text-white bg-[#1A1A1A] hover:bg-black rounded-full transition-all flex items-center justify-center gap-2 shadow-md cursor-pointer active:scale-95"
            >
        ...
        {/* Right Side: Embedded Themed Google Map Viewport (7 Cols on md/lg) */}
        <div className="md:col-span-7 bg-[#F6F6F6] min-h-[340px] sm:min-h-[420px] md:min-h-full relative flex flex-col border-t md:border-t-0 md:border-l border-black/10">
          {/* Header Bar Overlay */}
          <div className="bg-[#1A1A1A] text-white px-5 py-3.5 flex items-center justify-between text-xs font-sans tracking-widest uppercase z-10 shrink-0">
          ...
          {/* Embedded Google Map iframe with Website Theme Styling */}
          <div className="flex-1 w-full h-full min-h-[300px] relative">
            <iframe
              ...
              className="w-full h-full min-h-[300px] border-0 filter grayscale contrast-125 brightness-95"
              allowFullScreen=""
              loading="lazy"
